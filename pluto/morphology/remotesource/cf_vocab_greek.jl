...
# ╔═╡ ed13942b-cc62-4a50-b6f4-46be300e9c09
md"""## Vocabulary comparison: string tokens"""

# ╔═╡ 5187fb8e-8186-435f-b2de-318a60b38264
md"""### Citable text corpora

We could compare any pair of texts.  Here, we'll use EAGL texts for Xenophon's *Oeconomicus* as text 1, and Lysias' first oration as text 2.
"""

# ╔═╡ 1a6d272b-705d-4643-97f1-450d53acf819
src1 = joinpath(dirname(pwd()), "texts", "oeconomicus.cex")

# ╔═╡ 239ee36a-f34c-432b-9d3f-345422d99668
src2 = joinpath(dirname(pwd()), "texts", "lysias1.cex")

# ╔═╡ b5cbb1a9-ee3b-4236-af73-84fa9f278665
corpus1 = fromcex(src1, CitableTextCorpus, FileReader)

# ╔═╡ 5daa9167-1632-4819-bed6-fc0591d709ba
corpus2 = fromcex(src2, CitableTextCorpus, FileReader)

# ╔═╡ 3f42716a-4b5e-4983-b934-8892045eaf37
md"""### Histograms of lexical tokens"""

# ╔═╡ 17350592-8a0d-4db8-99a4-ae1f4a7dfba1
histo1 = corpus_histo(corpus1, lg, filterby = LexicalToken())#, normalizer =  knormal)

# ╔═╡ f6804b65-9960-4a62-9471-630510459248
histo2 = corpus_histo(corpus2, lg, filterby = LexicalToken())
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "5c6a310dda3b6eaeb594706a9f63d1881acec0eb"
...
git-tree-sha1 = "b87adb2a3914a610379bbbc1057a60816b77c77b"
