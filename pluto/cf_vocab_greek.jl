...
xenfile = joinpath(dirname(pwd()), "texts", "oeconomicus.cex")

# ╔═╡ b5cbb1a9-ee3b-4236-af73-84fa9f278665
xen = fromcex(xenfile, CitableTextCorpus, FileReader)

# ╔═╡ 239ee36a-f34c-432b-9d3f-345422d99668
lysfile = joinpath(dirname(pwd()), "texts", "lysias1.cex")

# ╔═╡ 5daa9167-1632-4819-bed6-fc0591d709ba
lys = fromcex(lysfile, CitableTextCorpus, FileReader)

# ╔═╡ 17350592-8a0d-4db8-99a4-ae1f4a7dfba1
xenhist = corpus_histo(xen, lg, filterby = LexicalToken())#, normalizer =  knormal)

# ╔═╡ f6804b65-9960-4a62-9471-630510459248
lyshist = corpus_histo(lys, lg, filterby = LexicalToken())

# ╔═╡ 0f14ab53-2da6-4287-8380-25fb428d2c4f
vocab1 = keys(xenhist) |> collect


# ╔═╡ d68c208c-a234-475d-8702-55691ebf096a
vocab2 = keys(lyshist) |> collect
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "fc0f59af4b6365bcea994de9928da396dc347a1b"
...
git-tree-sha1 = "76be2cb28113fb45122331b4e48996752b452418"
...
git-tree-sha1 = "51d57db01fd6a13d5f89a0ef38c9fd03dbcb7011"
...
git-tree-sha1 = "979cb61c185e8c537741df4ea7a067b043ca7d6e"
