...
# ╔═╡ 9266e2d0-9290-11ed-3c52-07caae036594
begin
	using GreekSyntax
...
# ╔═╡ 3cb40604-e426-4103-aee9-eb9007e865b9
md"""*Load from* $(@bind srctype Select(["", "url", "file"]))"""

# ╔═╡ f7593baa-7ba4-4f46-8abf-8374df3b9212
if srctype == "url"
	md"""*Source URL*: $(@bind url confirm(TextField(80; default = 
	"https://raw.githubusercontent.com/neelsmith/eagl-texts/main/texts/lysias1.cex")))
	"""
elseif srctype == "file"
	
	defaultdir = joinpath(dirname(pwd()), "texts")
	md"""*Source directory*: $(@bind basedir confirm(TextField(80; default = defaultdir)))"""
end

# ╔═╡ 716925f8-94f0-4de4-be8a-d7df01194b77
md"Set `basedir` to $(basedir)"

# ╔═╡ baccd159-4a4e-4162-9097-0e62e7c0aca8
if srctype == "file"
	
	cexfiles = filter(readdir(defaultdir)) do fname
		endswith(fname, ".cex")
	end
	datasets = [""]
	for f in cexfiles
...
# ╔═╡ 1cca58fb-827e-41a2-b96f-4afb1bd7da62
c = fromcex(joinpath(basedir, dataset), CitableTextCorpus,FileReader)

# ╔═╡ 4513080b-6d8d-4f15-90b1-2bae800e74c3
...
julia_version = "1.8.4"
manifest_format = "2.0"
project_hash = "96e56a35090842824fe2cfca1f19d4fcaf85fe8a"
...
git-tree-sha1 = "f431a68294926d486ce1973a6ec8a9f3e1e9ebf6"
